/**
  ...
  *
  * 4. The default value of HSI crystal is set to 8MHz, refer to "HSI_VALUE" define
  *    in "stm32f0xx.h" file. When HSI is used as system clock source, directly or
  *    through PLL, and you are using different crystal you have to adapt the HSI
...
{    
  ...
  RCC->CR &= (uint32_t)0xFEF6FFFF;  /* HSEON - [16] CSSON - [19] PLLON - [24] */
...
static void SetSysClock(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    /* PCLK = HCLK/16 */
    RCC->CFGR |= (uint32_t)RCC_CFGR_PPRE_DIV16;

    /* PLL configuration = HSI * 4 = 32 MHz */
